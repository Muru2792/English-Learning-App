...
import in22labs.englishlearning.VideoHome.VideosActivity;
...
public class PracticeHome extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.practice_layout,null);
    }
    ...
    private class cardPractice extends BaseAdapter{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.card_feed=(CardView)rowView.findViewById(R.id.card_training);
